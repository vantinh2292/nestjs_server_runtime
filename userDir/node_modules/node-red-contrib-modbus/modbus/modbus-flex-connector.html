...
data-i18n='modbus-contrib.label.server'></span></label> <input type='text' id='node-input-server'> </div> <!-- <hr>
    ...
    </div> --> <hr> <div class='form-row'> <label style='min-width:190px' for='node-input-showStatusActivities'><i 
class='fa fa-th'></i> <span data-i18n='modbus-contrib.label.showActivities'></span></label> <input type='checkbox' 
