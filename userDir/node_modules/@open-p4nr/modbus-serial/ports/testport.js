...
class TestPort extends EventEmitter {
    ...
    write(data, argumentMap) {
        ...
        // TODO(Kay): Disabled for testing purposes ! Re-enable later !
        ...
        if(functionCode === 0x7F) {
            ...
            buffer.writeUInt16BE(0xCAFE, 2);
        }
        if (functionCode === 0x40) {
            buffer = Buffer.alloc(43);
            buffer.writeUInt8(unitNumber, 0);
            buffer.writeUInt8(functionCode, 1);
            buffer.writeUInt8(0x28, 2);


            buffer.writeUInt16BE(0xAAAA, 3); // ACMX
            buffer.writeUInt16BE(0xBBBB, 5); // ACMN
            buffer.writeUInt16BE(0xCCCC, 7); // DCMX
            buffer.writeUInt16BE(0xDDDD, 9); // DCMN
            buffer.writeUInt16BE(0xEEEE, 11); // FMX
            buffer.writeUInt16BE(0xFFFF, 13); // FMN
            buffer.writeUInt16BE(0xAAAA, 15); // OT1
            buffer.writeUInt16BE(0xBBBB, 17); // OT2
            buffer.writeUInt16BE(0xCCCC, 19); // OT3
            buffer.writeUInt16BE(0xDDDD, 21); // OT4
            buffer.writeUInt16BE(0xEEEE, 23); // OT5
            buffer.writeUInt16BE(0xFFFF, 25); // COM
            buffer.writeUInt16BE(0xAAAA, 27); // ISL
            buffer.writeUInt16BE(0xBBBB, 29); // RES
            buffer.writeUInt16BE(0xCCCC, 31); // RES
            buffer.writeUInt16BE(0xDDDD, 33); // OVRCURR
            buffer.writeUInt16BE(0xEEEE, 35); // RES
            buffer.writeUInt16BE(0xFFFF, 37); // OVRVOLT
            buffer.writeUInt16BE(0xAAAA, 39); // AVRG
        ...
        if (buffer) {
            ...
            this.emit("data", buffer, argumentMap);
